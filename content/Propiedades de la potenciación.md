...
## Exponente negativo
Base $2$, exponente $-3$.
$$2^{-3}$$No tendría sentido intuitivamente el multiplicar una base por sí misma una cantidad negativa de veces, por lo que podemos intentar llegar a este valor de manera práctica usando la propiedad de división misma base distinto exponente, haciendo que, con la resta, el exponente se vuelva negativo:
